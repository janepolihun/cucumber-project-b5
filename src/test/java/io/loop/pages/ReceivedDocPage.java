...
//
//public class ReceivedDocPage {
//
//
//        public ReceivedDocPage() {
//            PageFactory.initElements(Driver.getDriver(), this);
//        }
//
//        @FindBy(xpath = "//button[contains(@class,'v-btn')][.//span[normalize-space()='Search']]")
...
//                case "search" -> {
//                    BrowserUtils.waitForClickable(searchButton, DocuportConstants.LARGE).click();
//                    Thread.sleep(3000);
//                }
...
//                case "document name" ->
//                        BrowserUtils.waitForVisibility(documentName, DocuportConstants.LARGE).sendKeys(input);
...
public class ReceivedDocPage {
    ...
    public void clickButton(String button) {
        ...
        switch (button.toLowerCase().trim()) {
            case "search" ->{
                    BrowserUtils.waitForClickable(searchButton, DocuportConstants.LARGE);
                    BrowserUtils.waitForClickable(searchButton, DocuportConstants.LARGE).click();
